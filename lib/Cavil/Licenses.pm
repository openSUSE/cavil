...
# Accept case-insensitive operators and harmless trailing operators from scanned metadata.
# Identifiers retain canonical SPDX case; aliases come from license_changes.txt.
