...
is_deeply $processor->hash, {destdir => $pwll, unpacked => {'README.processed.md' => {mime => 'text/plain'}}}, 'maxed';
...
is $pwt->child('package.processed.spec')->slurp, $pwt->child('package.stripped')->slurp, 'Correctly stripped spec file';
